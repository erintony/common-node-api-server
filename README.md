...
```sh
http POST http://localhost:1337/api/oauth/token grant_type=password client_id=web client_secret=web-api-v1 username=common password=123456
http POST http://localhost:1337/api/oauth/token grant_type=refresh_token client_id=web client_secret=web-api-v1 refresh_token=[REFRESH_TOKEN]
```
